...
L["Some settings require UI to be reloaded."] = "Einige Einstellungen benötigen ein erneutes Laden des UI."
L["enable the module."] = "Das Modul aktivieren."
L["disable the module."] = "Das Modul deaktivieren."
L["show module status."] = "Zeige Modulstatus."
L["Could not find module \"%s\""] = "Konnte Modul \"%s\" nicht finden."
L["Module \"%s\" already exists"] = "Modul \"%s\" existiert bereits."
L["Please reload ui."] = "Bitte UI neu laden."
L["Module Status"] = "Modulstatus"
L["module status: %s"] = "Modulstatus: %s"
L["enable module"] = "Modul aktivieren"
L["disable module"] = "Modul deaktivieren"
L["toggle module status"] = "Modulstatus ändern"
L["Tick the modules you want to disable."] = "Kreuzen Sie die Module an, die Sie deaktivieren wollen."
L["Acceptable commands for: |caaf49141%s|r"] = "Akzeptierte Kommandos für: |caaf49141%s|r"
L["Unknown Command. Type \"|caaf49141%s|r\" for a list of commands."] = "Unbekannte Eingabe. Gebe \"|caaf49141%s|r\" ein, für eine Liste aller Kommandos."
L["Available command for |caaf49141%s|r is |cffffd700%s|r"] = "Akzeptierte Kommandos für |caaf49141%s|r sind |cffffd700%s|r"
L["access |caaf49141%s|r module commands"] = "Rufe Kommandos ab für Modul |caaf49141%s|r"
L["to use the |caaf49141%s|r module"] = "um das Modul |caaf49141%s|r zu nutzen"
L["Enables or disables the module."] = "Aktiviert oder Deaktiviert das Modul."
L["Are you sure you want to reset %s to default?"] = "Möchten Sie wirklich %s zurücksetzen?"
L["Access module settings."] = "Moduleinstellungen abrufen."
L["Resets module settings to default."] = "Setzt die Moduleinstellungen zurück."
L["module's settings reset to default."] = "Das Modul wurde zurückgesetzt."
L["|cff00ff00enabled|r"] = "|cff00ff00aktiviert|r"
L["|cffff0000disabled|r"] = "|cffff0000deaktiviert|r"
L["|cff00ff00ON|r"] = "|cff00ff00AN|r"
...
-- Binder
L["Allows you to save your current keybinds as a profile that you can load whenever you want."] = "Ermöglicht Ihnen, alle aktuellen Keybinds als Profil zu speichern und künftig zu laden."
L["Create Profile"] = "Profil erstellen"
L["Enter the name of the new profile then press Enter or click OK.\nThe new created profile will store the keybinds you are currently using."] = "Geben Sie den Namen des Profils ein und bestätigen Sie mit Enter oder OK.\nDas neu erstellte Profil wird alle Keybinds speichern, die Sie derzeit nutzen."
L["Restore Profile"] = "Ein Profil wiederherstellen"
L["Select the profile you want to restore or delete."] = "Wählen Sie das Profil aus, dass Sie wiederherstellen oder löschen möchten."

L["Are you sure you want to restore the profile: %s?"] = "Sind Sie sicher, dass Sie das folgende Profil aktivieren wollen: %s?"
L['Profile "%s" successfully restored.'] = 'Profil "%s" erfolgreich wiederherstellt.'
L["Are you sure you want to delete the profile: %s?"] = "Sind Sie sicher, dass Sie das folgende Profil löschen wollen: %s?"
L['Profile "%s" successfully deleted.'] = 'Profil "%s" erfolgreich gelöscht.'
-- BlizzMove
L["Click the button below to reset all frames."] = "Klicken Sie auf den Button um alle Fenster zurückzusetzen."
L["Move/Lock a Frame"] = "Fenster freigeben/sperren"
L["%s will be saved."] = "%s wird gespeichert."
L["%s will not be saved."] = "%s wird nicht gespeichert."
L["%s will move with handler %s"] = "%s will move with handler %s"
-- ActionBars
L["Allows you to tweak your action bars in the limit of the allowed."] = "Ermöglicht Ihnen, die ActionBars anzupassen."
L["Hide Gryphons"] = "Greifen verstecken"
L["Range Detection"] = "Distanzmessung"
L["Turns your buttons red if your target is out of range."] = "Färbt die Fähigkeiten rot, wenn Sie außer Reichweite sind."
L["Dark Mode"] = "Dark Mode"
L["Hover Mode"] = "Schwebemodus"
L["Shows your right action bars on hover."] = "Zeigt die ActionBars rechts beim darüberfahren."
L["Scale"] = "Skalieren"
L["Changes action bars scale"] = "Ändert die Größe der ActionBars."
L["Hotkeys"] = "Hotkeys"
L["Changes the opacity of action bar hotkeys."] = "Ändert die Deckkraft der Hotkeys auf der ActionBar."
-- ActionBarSaver
L["Count"] = "Zählen"
L["Rank"] = "Rang"
